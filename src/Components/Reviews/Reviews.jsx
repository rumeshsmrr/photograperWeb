      ...
      >
        ...
        >
          {reviewData.map((review) => (
            <motion.div key={review.index} className="group relative p-4">
              <motion.div
              ...
              >
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.3, ease: "easeInOut" }}
                >
                  <div className="text-xl font-simple tracking-tight w-80% text-wrap h-auto">
                    {review.name}
                  </div>
                  <div className="w-full h-fit flex flex-col gap-5">
                    <img
                      ...
                      alt="Quotation mark"
                    />
                    <div className="font-regular text-wrap text-xs">
                      {review.review}
                    </div>
                  </div>
                </motion.div>
