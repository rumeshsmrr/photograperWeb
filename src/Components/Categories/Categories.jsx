...
export default function Categories() {
  return (
    <div className='pt-2 px-4 md:px-10 mt-10 bg-inherit w-full  h-fit flex flex-col justify-center'>
      ...
      transition={{ duration: 0.5, delay:0 }}
    >
      <img className='rounded-3xl w-full h-full object-cover' src={cat1} alt='wedding' />
      <motion.div
    ...
    >
      <img className='rounded-3xl w-full h-full object-cover' src={cat2} alt='wedding' />
      <motion.div
        className='absolute inset-0 bg-white opacity-0'
        initial={{ opacity: 0 }}
        whileHover={{
    ...
    >
      <img className='rounded-3xl w-full h-full object-cover' src={cat3} alt='wedding' />
      <motion.div
        className='absolute inset-0 bg-white opacity-0'
        initial={{ opacity: 0 }}
        whileHover={{
...
//     <div className='w-full flex flex-wrap gap-3 justify-center '>
//     <motion.div
//       className='relative catCard cursor-pointer w-[300px] md:w-[350px] lg:w-[400px] h-[300px] md:h-[450px] lg:h-[550px]'
//       initial={{ x: 100, opacity: 0 }}
//       whileInView={{ x: 0, opacity: 1 }}
